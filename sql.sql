-- CREATE TABLE Animals (animal_id INTEGER PRIMARY KEY AUTOINCREMENT, animal_name TEXT NOT NULL, animal_description TEXT NOT NULL);


-- INSERT INTO Animals (animal_name, animal_description) VALUES
